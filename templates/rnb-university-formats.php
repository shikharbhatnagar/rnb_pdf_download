...
$heading = '<a href="'.$dbsiteurl.'/format-guidelines">University Formats & Guidelines</a> - '.$university_slug_rows[0]['vuniversity_title'];
...
window.addEventListener("click", (e) => {
    ...
    if(ele_type == 'radio'){
    	...
    	new_url = current_url.origin+"/university/<?php echo $univ_param; ?>/"+e.originalTarget.attributes[2].value;
